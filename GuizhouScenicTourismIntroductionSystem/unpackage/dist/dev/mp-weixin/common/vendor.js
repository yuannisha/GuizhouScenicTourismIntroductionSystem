...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__EFA86C7",
    appName: "GuizhouScenicTourismIntroductionSystem",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.110.151,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_0hKVEN";
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "文化列表"
    }
  },
  {
    path: "pages/culture/detail",
    style: {
...
const tabBar = {
  ...
  list: [
    ...
    {
      pagePath: "pages/scenic/list",
      text: "景点",
      iconPath: "static/tabbar/scenic.png",
      selectedIconPath: "static/tabbar/scenic-active.png"
    },
    {
